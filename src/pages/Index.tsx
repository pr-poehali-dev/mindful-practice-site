...
const SERVICES = [
  ...
  },
  {
    ...
    duration: "2–3 часа",
    desc: "Каждая программа собирается индивидуально — под ваше тело, ритм и состояние. Три формата: глубокое расслабление, сброс накопленного напряжения или экспресс-перезагрузка за 90 минут. Тепло, пар, веники из кавказского дуба и авторские ароматические ритуалы — всё подбирается с учётом вашей физиологии, чтобы тело ответило, а не просто прогрелось.",
    perks: ["Программа под вашу физиологию", "Расслабление / сброс напряжения / перезагрузка", "Веники кавказского дуба", "Выезд в любую точку"],
    price: "Уточняйте",
    color: "#EDE0DC",
  },
  {
